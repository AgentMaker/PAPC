...
def create_kitti_info_file(data_path,
                           ...
                           relative_path=True):
    train_img_ids = _read_imageset_file("./kitti/train.txt")
    val_img_ids = _read_imageset_file("./kitti/val.txt")
    trainval_img_ids = _read_imageset_file("./kitti/trainval.txt")
    test_img_ids = _read_imageset_file("./kitti/test.txt")
